...
Discovers ops from:
    ...
    forge/packages/core_ops/<name>/op.py
    forge/packages/custom_ops/<name>/op.py
...
def set_user_ops_root(path):
    """Set the one trusted user-operation filesystem root."""
    global USER_OPS_ROOT
    ...
    USER_OPS_ROOT = os.path.abspath(
        value
    )

    return USER_OPS_ROOT


def get_user_ops_root():
    """Return the currently active trusted user-operation root."""
    return USER_OPS_ROOT
